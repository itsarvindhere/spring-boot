...
Note that we have to use "merge" inside "entityManager.remove" method in this case because we are getting the employee object from outside. If you did not understand what that means, then go over the "Deleting Objects with JPA" file in the "Hibernae & JPA" notes.
